...
def get_market_news():
    ...
    prompt = """Find the top 5-7 most important market-moving headlines and breaking news right now. Focus on:
- Major economic data releases
- Central bank announcements
- Geopolitical events affecting markets
- Corporate earnings or major company news
...
def analyze_market_sentiment(news_data, risk_data):
    ...
    user_prompt = f"""
Analyze the current market conditions based on:
...
1. What's driving market sentiment right now
2. How investors are reacting (risk-on vs risk-off)
3. Any arbitrage opportunities or misalignments
4. What this suggests about near-term market direction
5. Key risks or opportunities to watch

Be strategic and actionable. Focus on the most important insights. But read between the lines and try and decipher what's really going on.
"""
